...
mod tests {
    ...
    async fn test_add_user() {
        ...
        let user = User {
            email: Email::parse("ibrahim@umbrella.corp".to_owned()).unwrap(),
            password: Password::parse("$3curedZ".to_owned()).unwrap(),
            requires_2fa: false,
        };
    ...
    async fn test_get_user() {
        let mut user_store = HashmapUserStore::default();
        let email = Email::parse("ibrahim@umbrella.corp".to_owned()).unwrap();
        ...
        let result = user_store
            .get_user(&Email::parse("i@umbrella.corp".to_owned()).unwrap())
            .await;
    ...
    async fn test_validate_user() {
        let mut user_store = HashmapUserStore::default();
        let email = Email::parse("ibrahim@umbrella.corp".to_owned()).unwrap();
        let password = Password::parse("$3curedZ".to_owned()).unwrap();
        ...
        let wrong_password = Password::parse("incorrectPassword".to_owned()).unwrap();
        ...
        let result = user_store
            .validate_user(
                &Email::parse("i@umbrella.corp".to_string()).unwrap(),
                &password,
            )
            .await;
